          ...
          >
            ...
            <div className="p-8 bg-emerald-600 text-white flex justify-between items-center shrink-0">
              <div>
                ...
                <p className="text-emerald-100 text-xs font-bold uppercase tracking-widest mt-1 opacity-80">
            ...
            <div className="p-8 overflow-y-auto flex-grow custom-scrollbar">
              <div className="mb-8 p-6 bg-emerald-50 rounded-2xl flex gap-4 items-start border border-emerald-100">
              ...
              <div className="space-y-4">
                {courses.map((course, index) => (
                  <motion.div
                    ...
                    className="flex flex-wrap sm:flex-nowrap gap-3 items-end p-5 sm:p-6 rounded-2xl bg-gray-50 border border-gray-100"
                  >
