                    ...
                    {event?.flyer_url && (
                        ...
                        >
                            <div className="relative group">
                                ...
                                <div className="relative zeni-card p-4 bg-white overflow-hidden rounded-[3rem] shadow-2xl border-white border-8">
                                    <img
                                        src={event.flyer_url}
                                        alt={event.title}
                                        className="w-full h-full object-cover rounded-[2rem] transform group-hover:scale-[1.02] transition-transform duration-700 font-black text-emerald-900"
                                    />
                                </div>
                            </div>
                        </motion.div>
