        ...
        <section className="py-24 bg-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 max-w-4xl relative z-10 text-center">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-6xl font-serif font-bold text-slate-900 mb-6 tracking-tight">The Anthem.</h2>
                ...
                >
                    ...
                    <div className="space-y-8 font-serif text-lg md:text-2xl leading-relaxed text-slate-600 italic">
                        <p>
                            <span className="text-amber-600 font-bold not-italic">SUCF the Unique Family</span><br />
                        ...
                        <p>
                            <span className="text-amber-600 font-bold not-italic">Jesus the answer, He is the way</span><br />
